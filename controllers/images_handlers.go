...
func NewImageHandlers(db *database.Queries, dir string) *ImagesHandlers {
...
// @Router       /v1/projects/images/{id} [post]
// @Security Bearer
func (ih *ImagesHandlers) Display(w http.ResponseWriter, r *http.Request, user views.User) {
	...
	// http.FileServer(http.Dir(imageId))
...
// @Router       /v1/projects/images [post]
// @Security Bearer
func (ih *ImagesHandlers) UploadImage(w http.ResponseWriter, r *http.Request) {
	...
	fpath := fmt.Sprintf("%s%s", ih.imageDir, fileName)
